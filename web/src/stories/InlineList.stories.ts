...
storiesOf("InlineList Storybook - Row 방향", module)
  ...
  .add("align center", () =>
    InlineList({ class: InlineListClass.ALIGN_CENTER })(contents)
  )
  .add("align right", () =>
...
storiesOf("InlineList Storybook - Column 방향", module)
  ...
  .add("align center column base", () =>
    InlineList({ class: InlineListClass.ALIGN_CENTER_COLUMN })(contents)
  )
  .add("align right column base", () =>
    InlineList({ class: InlineListClass.ALIGN_RIGHT_COLUMN })(contents)
  );
